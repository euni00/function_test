package com.cookandroid.dialog_test;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerButton = (Button) findViewById(R.id.timerbt);
        timerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialogView = (View) View.inflate(MainActivity.this, R.layout.dialog, null);  // inflate 함수로 dialog.xml코드를 객체화해 코드를 사용
                AlertDialog.Builder dlg = new AlertDialog.Builder(MainActivity.this);
                dlg.setTitle("타이머");
                dlg.setMessage("내용");
                dlg.setView(dialogView);
                timerDialogFunction();  // showTimerDialog 함수를 호출
    ...
    public void timerDialogFunction() {  // showTimerDialog 함수를 정의
